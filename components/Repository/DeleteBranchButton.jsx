  ...
  return (
    <>
      <button
        ...
        className="px-2 py-1 text-xs rounded bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 hover:bg-red-200 dark:hover:bg-red-900/50 transition"
        title="Delete branch"
      >
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-lg p-6 w-full max-w-md">
            ...
            <div className="mb-4 p-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded">
              <p className="text-sm text-yellow-800 dark:text-yellow-300">
                ⚠️ You are about to delete the branch <span className="font-semibold">"{branchName}"</span>. All file pointers for this branch will be removed.
              </p>
            </div>
